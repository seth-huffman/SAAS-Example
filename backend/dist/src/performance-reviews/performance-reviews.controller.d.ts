...
export declare class PerformanceReviewsController {
    ...
    deleteSelf(id: string, user: AuthUser): Promise<void>;
    updateSelf(id: string, dto: UpdateSelfReviewDto, user: AuthUser): Promise<import("./entities/performance-review.entity").PerformanceReview>;
